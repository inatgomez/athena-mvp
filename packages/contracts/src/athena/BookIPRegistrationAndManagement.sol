...
contract BookGateway is Ownable, Pausable {
    ...
    address public immutable supportedCurrency; // e.g., USDC
    ...
    event BookRegistered(
        ...
        uint256[] indexed licenseTermsIds
    );
    ...
    ///@notice Register a book as original IP with predefined license types
    ///@param recipient The recipient of the IP Asset (the author)
    ///@param ipMetadata Metadata for the IP Asset (the book)
    ///@param licenseType Type of license (0: Non-Commercial, 1: Commercial $10, 2: Creative Commons)
        ...
        )
    {
        ...
        // Mint NFT, register IP, attach license terms, and transfer to recipient
        ...
        if (licenseType == 1 && customCommercialFee > 0) {
    ...
    ///@param parentIpIds Array of parent IP Asset IDs this derivative is based on
    ...
    function registerDerivative(
        ...
        WorkflowStructs.MakeDerivative memory derivData = WorkflowStructs
            .MakeDerivative({
    ...
    ///@param licenseType 0: Non-Commercial, 1: Commercial, 2: Creative Commons
    ...
    ) internal view returns (WorkflowStructs.LicenseTermsData[] memory) {
        WorkflowStructs.LicenseTermsData[]
